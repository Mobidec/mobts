...
- [GitHub Repository](https://github.com/Mobidec/mobts.git)
- [Issues](https://github.com/Mobidec/mobts/issues)
- [Changelog](https://github.com/Mobidec/mobts/blob/main/CHANGELOG.md)
- [PyPI](https://pypi.org/project/mobts/)
...
Your automaticly generated documentation (with Sphinx) is [Here](https://mobidec.github.io/mobts/)
...
```bash
# On-premise
pip install mobts --extra-index-url https://nexus.ifpen.fr/repository/fast-it/simple

# On Cloud
pip install mobts --extra-index-url https://nexus.fastit.dev/repository/fast-it/simple
```
...
---
>>>>>>> 49fe879f9b3007998c5399531249b101fabb2887
