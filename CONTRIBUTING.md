...
pip install build
python -m build
twine check dist/mobts-0.0.0-py3-none-any.whl
pip install dist/mobts-0.0.0-py3-none-any.whl
pytest
```

Replace `mobts` with the name of your repository. Once installed, the package becomes part of your dependencies, and you can use it in your code with `import mobts` or `from mobts import module`.
